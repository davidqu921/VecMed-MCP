...
# ==== 高层封装：从文本到搜索结果 ====
def search_pubmed_by_query(query: str, top_k: int = 5) -> List[Dict]:
    print(f"\n🎯 开始检索: \"{query}\"")
...
if __name__ == "__main__":
    example_query = "Current treatment strategies for external auditory canal cancer."
    results = search_pubmed_by_query(example_query, top_k=5)
